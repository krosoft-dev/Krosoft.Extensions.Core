...
/// <summary>
/// Exception à retourner en cas d'erreur fonctionnelle soulevé par le code de l'application.
/// </summary>
public class KrosoftFunctionalException : HttpException
{
    public KrosoftFunctionalException(string? erreur,
        ...
        : base(HttpStatusCode.BadRequest, erreur, innerException)
    {
        Errors = errors;
    }
    ...
    public KrosoftFunctionalException(ISet<string> errors,
                                      Exception? innerException = null)
        : this(errors.FirstOrDefault(), errors, innerException)
    {
        Errors = errors;
    }
    ...
    public KrosoftFunctionalException(string erreur,
                                      Exception? innerException = null)
        : this(new HashSet<string> { erreur }, innerException)
    {
    }
