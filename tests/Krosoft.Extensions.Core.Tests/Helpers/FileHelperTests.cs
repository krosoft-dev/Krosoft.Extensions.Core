...
public class FileHelperTests
{
    ...
    [TestMethod]
    public void ReadAsStringArrayAsync_WithNullFilePath_ThrowsKrosoftTechnicalException()
    {
    ...
    [TestMethod]
    public void ReadAsStringArrayAsync_WithEmptyFilePath_ThrowsKrosoftTechnicalException()
    {
    ...
    [TestMethod]
    public void ReadAsStringArrayAsync_WithWhitespaceFilePath_ThrowsKrosoftTechnicalException()
    {
    ...
    public void ReadAsStringArrayAsync_WithNonExistentFile_ThrowsFileNotFoundException()
    {
        ...
        Check.ThatCode(() => FileHelper.ReadAsStringArrayAsync(filePath, Encoding.UTF8))
             ...
             .WithMessage($"Could not find file '{filePath}'.");
    }
